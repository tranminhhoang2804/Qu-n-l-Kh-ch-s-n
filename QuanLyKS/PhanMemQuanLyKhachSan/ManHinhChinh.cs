...
namespace PhanMemQuanLyKhachSan
{
    public partial class frmManHinhChinh : Form
    {
            ...
            if (hd2 != null)  // cần thêm đk && ngay hoa don >= datetime.Now
            {
                ...
                //{
                    ...
                    if (findBook != null)
                    {
                        ...
                        //lblNoiDungNgayDen2.Text = dt1.AddDays(0 - hd2.SoDem.Value).ToString("dd/MM/yyyy");
        ...
        private void capNhatVatTuToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void capNhatDichVuToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void capNhatLoaiPhongToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void capNhatThongTinNhanVienToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void capNhatLichLamViecNhanVienToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void lblHienTrang_Click(object sender, EventArgs e)
        {

        }

        private void lblNoiDungSoKhach6_Click(object sender, EventArgs e)
        {
                    }

        private void lblNoiDungTenBooking1_Click(object sender, EventArgs e)
        {
